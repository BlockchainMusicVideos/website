...
const amplifyDirectories = [
	...
	join(process.cwd(), 'build', 'compute'),
	join(process.cwd(), 'build', 'compute', 'default'),
	join(process.cwd(), 'build', 'compute', 'default', 'node_modules')
];
...
// Write the config to build/deploy-manifest.json
writeFileSync(
	join(process.cwd(), 'build', 'deploy-manifest.json'),
